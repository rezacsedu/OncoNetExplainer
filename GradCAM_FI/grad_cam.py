...
def compute_saliency_for_classes(layer_name='last_conv', colormap=True):
    ...
    :return:
    '''
    labels_index = {"0.0": 0, "1.0": 1, "2.0": 2, "3.0": 3, "4.0": 4, "5.0": 5, "6.0": 6, "7.0": 7, "8.0": 8, "9.0": 9,"10.0": 10, "11.0": 11, "12.0": 12, 
                    "13.0": 13, "14.0": 14,"15.0": 15, "16.0": 16, "17.0": 17, "18.0": 18, "19.0": 19, "20.0": 20, "21.0": 21, "22.0": 22, "23.0": 23, 
                    "24.0": 24,"25.0": 25, "26.0": 26, "27.0": 27, "28.0": 28, "29.0": 29, "30.0": 30, "31.0": 31, "32.0": 32}
    ...
    for cl in range(N_CLASSES):
        ...
        for fold in range(N_FOLDS):
            ...
            for k, v in draw_areas.items():
                ...
                if importence > (v / 2):
                    img_colormap = cv2.rectangle(img_colormap, (k[1], k[0]), (k[1] + shape[1], k[0] + shape[0]),(0, 0, 255),2)
